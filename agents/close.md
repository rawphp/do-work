...
Report:  <markdown: user-requests/UR-NNN/closure.md | linear: Project Milestone ## Closure + comment via write_close_report | sqlite/do-work-io: write_close_report port op>
```
