...
- REQ / Issue identity and status via port ops in `agents/tracker/do-work-io.md` only (no `working/REQ` globs)
- Review remains a code/evidence gate; do not invent local REQ markdown as store
