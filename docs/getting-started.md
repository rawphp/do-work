...
A **fourth backend** stores Issues/REQs only on do-work.io (remote MCP) — still no dual-write, still local git/worktrees. Setup details: [Troubleshooting → do-work.io tracker backend](troubleshooting.md#do-workio-tracker-backend).
